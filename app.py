...
pickleFile = open(r"C:\Users\kpaja\OneDrive\Desktop\Career-Prediction-System-main\weights.pkl", "rb")
...
def main():
  ...
  html1="""
    <div style="text-align:center; text-shadow: 3px 1px 2px purple;">
      <h1>👨🏻‍💻Career Mapping Prediction 👨🏻‍💻</h1>
    </div>
      """
  ...
  html3="""
    ...
    <div style="color:NAVY BLUE; margin:90px; text-align:center;">
               DEVELOPED  BY   
                   DHARANI CHALAPADI 
    </div>
      """
